function E = calculateEnergyFunction3d(f, g, gradient, sigma, mu, lambda, patchsize, p,C, R, Z, numberOfVolumes)
    ...
    for current=1:numberOfVolumes
        [currentLookUpRow,currentLookUpColumn] = compute_Q3d(currentVolumes{current}, patchsize,p);
    ...
    E_ges = E_data + E_tv_xyz + E_quasi ;
    
    E = [E_data, E_tv_xyz, E_quasi, E_ges];
